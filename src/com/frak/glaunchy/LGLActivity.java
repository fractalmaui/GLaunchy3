  ...
  \____|_____\__,_|\__,_|_| |_|\___|_| |_|\__, |
   ...
   OpenGL chooser: Creates a 3D interactive view with a list of apps to choose from...
    ...
    DHS June 6 2014: Initial Build for submittal...
     ...
     DHS June 7: Added "Selected" Tic sound as paddlewheel spins, goes off once for each new selection
*/
        	...
        	if (mGLView != null) 
        		{
        		  ...
        		  if (((MyGLSurfaceView) mGLView).getNeedTicSound() != 0)
        		  {
        			  //Make sound here!
        	            ((AudioManager) getSystemService(Context.AUDIO_SERVICE)).playSoundEffect(Sounds.SELECTED);
        			  ((MyGLSurfaceView) mGLView).clearNeedTicSound();
        		  }
...
class MyGLSurfaceView extends GLSurfaceView {
   ...
   //=====Glaunchy=============================================2014
   public int getNeedTicSound()
   {
       //Just pass the call on down...
       if (MyGlRe == null) return 0;
       return MyGlRe.getNeedTicSound();
   }
   ...
   //=====Glaunchy=============================================2014
   public void clearNeedTicSound()
   {
       //Just pass the call on down...
       if (MyGlRe == null) return;
       MyGlRe.clearNeedTicSound();
   }
